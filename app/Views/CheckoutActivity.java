...
//        orderId = getIntent().getStringExtra("orderId");
        ...
        String useraddress = SharedPreferenceSingleton.getInstance(getApplicationContext()).getString("flataddress","Address not provided, please add the exact locality below");
        ...
        if (requestCode == PLACE_PICKER_REQUEST) {
            if (resultCode == RESULT_OK) {
                ...
                if (place.getAttributions() == null) {
                    ...
                    Toast.makeText(getApplicationContext(),"No attribution "+String.valueOf(latitude),Toast.LENGTH_LONG).show();
                } else {
