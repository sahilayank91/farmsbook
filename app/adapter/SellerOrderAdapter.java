...
//
    ...
    private void orderWithItems (View view, String order) throws JSONException {
        ...
        for(int i=0;i<jsonArray.length();i++){
            ...
            arrayAdapter.add("Name - " + jsonObject.get("name") + ",Brand - " + jsonObject.getString("brand") + ", Quantity -" + jsonObject.getString("quantity") +",Unit used - "+jsonObject.getString("unit") +  ", Total- " + jsonObject.getString("total"));
        }
